  ...
  <main className={styles.main}>
      ...
      <div className={styles.textContent}>
        <div className={styles.leftContent}>
          ...
          <p className={styles.subText}>
            Hey! our delicious food is waiting
            for you, we are always near with finger licking sumcious food
          </p>
        ...
        <ul className={styles.ul}>
          <li className={styles.li}>
            <DeliveryDiningOutlinedIcon className={styles.deliver} />
            {' '}
            Free Delivery
          </li>
          <li className={styles.li}>
    ...
    <section className={styles.aboutUs}>
      ...
      <div className={styles.aboutUsTextArea}>
        ...
        <div className={styles.border} />
        <p className={styles.aboutUserDescription}>
          This is the type of restaurant which typically serve food and drinks
        ...
        <button className={styles.makeOrder} type="button">Make order</button>
      </div>
    </section>
...
Home.propTypes = {
  ...
  foodList: PropTypes.func.isRequired,
};
